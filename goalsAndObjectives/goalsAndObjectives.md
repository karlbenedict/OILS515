...
[Lecture 1 - Introduction to Python Programming](https://github.com/karlbenedict/scientific-python-lectures/blob/master/Lecture-1-Introduction-to-Python-Programming.ipynb)
...
# Week 15 - Data Sharing #

## Background ##

Increasingly, publishers and funding agencies are requiring that data associated with publications or produced with funding provided by funding organizations make those data available for public access and reuse within a reasonable amount of time and with minimum restrictions.  There exist a wide variety of options for meeting these requirements depending upon the nature (e.g. disciplinary context) of the data, funding source, publisher, and preferences of the researchers. In this week's materials we will look at some of the options for placing your data into disciplinary and general purpose repositories and also consider the role of complementary active archives that provide value added services based on data within those systems.   

## Expected Outcomes and Key Concepts ##

At the end of this class you should have an understanding of:

* The range of disciplinary and general-purpose repositories that are available for long-term preservation of access to research data
* The differences between disciplinary and general purpose repositories (including institutional repositories)
